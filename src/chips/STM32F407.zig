...
pub const devices = struct {
    ...
    pub const STM32F407 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  Universal synchronous asynchronous receiver transmitter
            pub const UART7 = @intToPtr(*volatile types.UART4, 0x40007800);
            ///  Universal synchronous asynchronous receiver transmitter
            pub const UART8 = @intToPtr(*volatile types.UART4, 0x40007c00);
            ///  Advanced-timers
            ...
            pub const SAI1 = @intToPtr(*volatile types.SAI1, 0x40015800);
            ///  LCD-TFT Controller
            ...
            ///  General-purpose I/Os
            pub const GPIOC = @intToPtr(*volatile types.GPIOI, 0x40020800);
            ///  General-purpose I/Os
            pub const GPIOD = @intToPtr(*volatile types.GPIOI, 0x40020c00);
            ///  General-purpose I/Os
            pub const GPIOE = @intToPtr(*volatile types.GPIOI, 0x40021000);
            ///  General-purpose I/Os
            pub const GPIOF = @intToPtr(*volatile types.GPIOI, 0x40021400);
            ///  General-purpose I/Os
            pub const GPIOG = @intToPtr(*volatile types.GPIOI, 0x40021800);
            ///  General-purpose I/Os
            pub const GPIOH = @intToPtr(*volatile types.GPIOI, 0x40021c00);
            ///  General-purpose I/Os
            pub const GPIOI = @intToPtr(*volatile types.GPIOI, 0x40022000);
            ///  General-purpose I/Os
            pub const GPIOJ = @intToPtr(*volatile types.GPIOI, 0x40022400);
            ///  General-purpose I/Os
            pub const GPIOK = @intToPtr(*volatile types.GPIOI, 0x40022800);
